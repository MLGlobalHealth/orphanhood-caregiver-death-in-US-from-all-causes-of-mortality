...
generate_edf8 <- function(mort.data.raw, mort.data, in.dir, prj.dir)
{
...
# population size----
# in a separate pop generating function
...
process_nchs_state_race_fertility_poisson <- function(in.dir, pop,rep.nb)
{
  ...
  # data.all.nchs <- as.data.table(readRDS(file.path(in.dir, 'NCHS', 'births', 'state_race_nchs_births.csv')))
